...
Page({
        ...
        if (this.data.currentTab != 3) {
            if (this.data.currentTab == 4) {
                wx.navigateTo({
                    ...
                    url: '../thesaurus/thesaurusReview/ThesaurusReviewPage?thesaurusName=' + e.target.dataset.text,
                    fail: function (res) {
                        console.log(res)
                    },
                    success: function (res) {
    ...
    getHasCreateThesaurus: function () {
        ...
        wx.request({
            ...
            success: function (res) {
                ...
                wx.request({
                    url: getApp().globalData.netServerAddrees + '/ep/queryAllCreateMemorandum',
                    success: function (res) {
                        console.log(res.data)
                        // var temList = new Array()
                        for (var index in res.data) {
    ...
    onCreatMorandum: function () {
        ...
        wx.request({
            url: getApp().globalData.netServerAddrees + '/ep/createMemorandumByString',
            // header:{'content-type':'multipart/form-data;boundary=1634796333288'},
            header:{'content-type':'application/x-www-form-urlencoded'},

            method:"POST",
            data:  {
                memorandumName: this.data.createThesaurusName,
                "description": '...',
